...
void RootNode::set_name(const std::string& _name) {
	name = _name;
}

std::string RootNode::get_name() {
	return name;
}
...
void ImportDirectiveNode::set_import_node_name(const std::string& _name) {
	import_node_name = _name;
}
...
std::string ImportDirectiveNode::get_import_node_name() {
...
void ContractDefinitionNode::set_contract_kind(std::string _kind) {
	kind = _kind;
}

std::string ContractDefinitionNode::get_contract_kind() {
	return kind;
}
