...
const std::string SmartContractKindInterface = "interface";
const std::string SmartContractKindContract = "contract";

const std::list<std::string> SmartContractKindList{
	SmartContractKindInterface,
	SmartContractKindContract
};
...
public:
	...
	void set_import_node_name(const std::string& _name);

    std::string get_file();
    std::string get_symbol_aliases();
    std::string get_unit_aliases();
    std::string get_original();
	std::string get_import_node_name();
    std::string source_code(Indentation& _indentation);
private:
    std::string file;
...
public:
	...
	void set_contract_kind(std::string _kind);
	std::string get_contract_kind();
